<template>
  ...
  >
    <v-container class="d-flex align-center">
      ...
      <div class="d-flex">
        <v-slide-x-reverse-transition appear v-if="$route.name == 'home' && pcOnly">
          <div class="d-flex">
            <v-btn
              v-for="link in links"
              :key="link.name"
        ...
        <v-slide-x-reverse-transition appear v-if="$route.name == 'founder' && pcOnly">
          <div class="d-flex">
            <v-btn
...
.v-application .navbar {
  ...
  &.soft-shadow {
    box-shadow: 0 0 transparent, 0 0 transparent, 0 5px 5px -4px rgba(0, 0, 0, 0.1) !important;
  }
